      ...
      <Card className="text-card-foreground border-border shadow-lg">
        <CardContent className="p-6 space-y-4 text-center">
          ...
          <Button
            ...
            size="lg"
          >
            <a href="https://app.rolplayinglife.com" target="_blank" rel="noopener noreferrer"> {/* Placeholder Link */}
           ...
           <p className="text-xs text-muted-foreground mt-4">
            <a href="https://blog.rolplayinglife.com" target="_blank" rel="noopener noreferrer" className="hover:text-accent underline">
